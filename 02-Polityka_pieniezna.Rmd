...
```{r rys25, echo=FALSE, fig.align='center', fig.cap='ŹrRelacja gotówki w obiegu do agregatu M1<br>Źródło: Opracowanie własne na podstawie danych NBP', out.width='100%'}
library(dplyr)
library(plotly)
...
flextable(tab3) %>% theme_vanilla() %>% 
     ...
     align(align = "center", part = "all") %>% 
     width(j=2:5, width = 2) %>% 
     set_caption("Proces dokonywania wydatków publicznych w warunkach polskich") %>% 
     add_footer_lines("Źródło: Opracowanie własne na podstawie M. Lavoie, (2013), The Monetary and Fiscal Nexus of Neo-Chartalism: A Friendly Critique, Journal of Economic Issues, Vol. XLVII, No. 1")
```
...
flextable(tab4) %>% theme_vanilla() %>% 
     ...
     align(align = "center", part = "all") %>% 
     width(j=2:5, width = 2) %>% 
     set_caption("Obecny proces dokonywania wydatków publicznych w warunkach polskich") %>% 
     add_footer_lines("Źródło: Opracowanie własne na podstawie M. Lavoie, (2013), The Monetary and Fiscal Nexus of Neo-Chartalism: A Friendly Critique, Journal of Economic Issues, Vol. XLVII, No. 1")
```
...
flextable(tab4) %>% theme_vanilla() %>% 
     ...
     align(align = "center", part = "all") %>% 
     width(j=2:5, width = 2) %>% 
     set_caption("Schemat kreacji pieniądza przez banki komercyjne") %>% 
     add_footer_lines("Źródło: Opracowanie własne")
```
